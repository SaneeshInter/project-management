...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Role code' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Department ID this role belongs to' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateRoleDto.prototype, "departmentId", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Whether role is active', default: true }),
    (0, class_validator_1.IsOptional)(),
