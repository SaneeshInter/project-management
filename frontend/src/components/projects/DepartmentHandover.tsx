...
export default function DepartmentHandover({
  ...
  const [currentChecklistProgress, setCurrentChecklistProgress] =
    useState<DepartmentChecklistProgress | null>(null);
  ...
  const fetchCurrentChecklistProgress = async () => {
    try {
      const progress = await projectsApi.getChecklistProgress(
        project.id,
      ...
      const filtered = userList.filter((user) => {
        ...
        return (
          ...
          (user.role?.includes("TL") &&
            user.departmentMaster?.code === department) || // Team leads in the department
  ...
  const handleHandover = async () => {
    ...
    try {
      ...
      const updatedProject = await projectsApi.moveToDepartment(
        project.id,
        handoverData
      );
      toast.success(
        `Project handed over to ${selectedDepartment.replace("_", " ")} successfully!`
      );
    ...
    <>
                ...
                <div className="flex flex-col items-end gap-1">
                  ...
                  {currentChecklistProgress && (
                    <Badge
                      ...
                      className="text-xs"
                    >
                      {currentChecklistProgress.completedItems}/
                      {currentChecklistProgress.totalItems} Items
                    </Badge>
                  )}
                </div>
              </div>
                ...
                currentChecklistProgress && (
                  <div className="mt-3 p-3 bg-orange-100 rounded border border-orange-200">
                    ...
                    <p className="text-xs text-orange-700">
                      {currentChecklistProgress.requiredItems -
                        currentChecklistProgress.completedRequiredItems}{" "}
                      required checklist items are incomplete. Consider
                      completing these before handover to ensure smooth
                      transition.
                    </p>
                  </div>
                )}
      ...
      {showHandoverModal && (
        <div
          ...
          onClick={(e) =>
            e.target === e.currentTarget && setShowHandoverModal(false)
          }
        >
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Choose the department to receive this project handover.
                    </p>
                    ...
                    <div className="space-y-3">
                        ...
                        {departments
                          ...
                          .map((dept) => (
                            <div
                              key={dept.code}
                              onClick={() =>
                                setSelectedDepartment(dept.code as Department)
                              }
                      ...
                      {departments.filter(
                        ...
                        <div className="text-center p-8 text-gray-500">
                          ...
                          <p className="text-sm">
                            No other departments available for handover
                          </p>
                        </div>
                      )}
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-orange-700 mb-2">
                                ...
                                Consider completing these before handover to
                                ensure smooth transition.
                              </p>
                              <p className="text-xs text-orange-600 font-medium">
                                You can still proceed, but the receiving
                                department may face issues.
                              </p>
                            </div>
                          </div>
                        </div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mb-6">
                      Assign team members and set timeline expectations for the
                      handover.
                    </p>
                          ...
                          <>
                            ...
                            {departmentUsers.length === 0 && !loadingUsers && (
                              <div className="text-center p-4 text-gray-500 bg-gray-50 rounded-lg">
                                ...
                                <p className="text-xs mt-1">
                                  Try selecting a different department or check
                                  if users are assigned to this department.
                                </p>
                              </div>
                            )}
                            ...
                            {departmentUsers.length > 0 && (
                              <p className="text-xs text-gray-600">
                                Found {departmentUsers.length} user
                                {departmentUsers.length !== 1 ? "s" : ""} in{" "}
                                {
                                  departments.find(
                                    (d) => d.code === selectedDepartment
                                  )?.name
              ...
              {currentStep === 3 && (
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mb-6">
                      Document and share relevant information, files, and notes
              ...
              {currentStep === 4 && (
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mb-6">
                      Review all details before completing the handover process.
                    </p>
                          ...
                          <div className="space-y-3 text-sm">
                            ...
                            {ktNotes && (
                              <div>
                                ...
                                <p className="text-gray-700 text-xs bg-white p-2 rounded border max-h-20 overflow-y-auto">
                                  {ktNotes}
                                </p>
                              </div>
                            )}
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-orange-700 mb-2">
                                {currentChecklistProgress.requiredItems -
                                  currentChecklistProgress.completedRequiredItems}{" "}
                                required items are not completed. This may cause
                                issues for the receiving department.
                              </p>
                              <p className="text-xs text-orange-600 font-medium">
